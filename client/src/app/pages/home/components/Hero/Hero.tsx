...
//             <Button fontSize="15px" backgroundColor="black" fontWeight="700" textColor="white">
//               <Link href="/">Get Started</Link>
//             </Button>
//             <Button textColor="black" backgroundColor="white" fontSize="15px" fontWeight="700">
...
export const Hero = () => {
  return (
    <section className="w-full h-auto relative z-1">
      <div className="border border-[var(--border-primary)] flex flex-col justify-center h-[450px] md:justify-between md:h-[661px] mt-8 md:mt-12 rounded-xl relative overflow-hidden p-8 md:p-10 ">
        <BackgroundHero />
        ...
        {/* Imagen solo en tablet en adelante */}
